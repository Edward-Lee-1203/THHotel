<%-- 
    ...
    Created on : Oct 19, 2020, 3:10:44 PM
    Author     : Admin
--%>
...
<body>
    ...
    <div class="container pt-5 pb-5">
        ...
        <p class="text-center">Please enter your booking information</p>
        <div class="d-flex justify-content-center">
            <div style="margin-right: 10px;">
                <div>
                    <input type="radio" name="searchType" value="bookingId"/>BookingId
                </div>
                <div>
                    <input type="radio" name="searchType" value="roomId"/>RoomId
                </div>
                <div>
                    <input type="radio" name="searchType" value="customerName"/>CustomerName

                </div>
            </div>    
            <div style="margin-top: 24px;">
                <input type="text" name="searchValue"/>
                <a href="" style="font-size: 14px;color: #ffffff;background: #F9AD81;display: inline-block;border: none;padding: 5px 25px;">Search</a>
            </div>
